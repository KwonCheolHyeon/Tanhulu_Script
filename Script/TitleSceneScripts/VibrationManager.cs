...
public class VibrationManager : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject vibrationOptionButton;
    [SerializeField]
    ...
    private void SetVibrationObject(UnityEngine.SceneManagement.Scene _scene)
    {
        if (_scene.name == "StoreScene")
        {
            vibrationOptionButton = GameObject.Find("Canvas").transform.Find("Setting_Tab").
                transform.Find("SettingPage").transform.Find("VibrationOption_Button").gameObject;
            vibrationOptionButton.GetComponent<Button>().onClick.AddListener(delegate { VibrationOptionChange(); });
            VirbrationImageChange();
        }
        else if (_scene.name == "TitleScene")
        {
            vibrationOptionButton = GameObject.Find("Title_Canvas").transform.Find("SettingTab").
                transform.Find("SettingPage").transform.Find("VibrationOption_Button").gameObject;
            vibrationOptionButton.GetComponent<Button>().onClick.AddListener(delegate { VibrationOptionChange(); });
            VirbrationImageChange();
        }
